...
Global_reactive_power <- as.character(Subset_Data$Global_reactive_power)
Voltage <- as.character(Subset_Data$Voltage)
...
plot(Subset_Data$Time, as.numeric(Voltage), type="l", xlab="datetime", ylab="Voltage")
